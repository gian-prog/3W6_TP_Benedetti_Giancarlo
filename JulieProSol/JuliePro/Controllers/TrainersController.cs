...
namespace JuliePro.Controllers
{
    public class TrainersController : Controller
    {
        ...
        {
            var  trainers = _context.Trainer.OrderBy(x => x.FirstName).ThenBy(x => x.LastName).Include(x => x.Speciality).ToList();

            return trainers != null ? View(trainers) : Problem("Entity set 'MyDbContext.Trainer'  is null.");
